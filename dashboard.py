...
renda_minima = float(tabela['Renda_Anual'].min())
renda_maxima = float(tabela['Renda_Anual'].max())
...
renda_filtrada = st.sidebar.slider("Faixa de Renda Anual (1000$):", min_value=renda_minima, max_value=renda_maxima, 
                                   value=(renda_minima, renda_maxima), step=1.0)
...
tabela_filtro = tabela_filtro[(tabela_filtro['Renda_Anual'] >= renda_filtrada[0]) & (tabela_filtro['Renda_Anual']<= renda_filtrada[1])]
